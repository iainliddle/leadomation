...
export default function CTASection() {
  ...
  return (
    ...
    >
      ...
      <div style={{ maxWidth: '900px', margin: '0 auto', paddingLeft: '48px', paddingRight: '48px', textAlign: 'center', position: 'relative', zIndex: 1 }}>
        ...
        >
          ...
          {/* Headline */}
          <div style={{ fontWeight: 800, fontSize: '64px', letterSpacing: '-0.03em', lineHeight: 1.05, background: 'linear-gradient(135deg, #0f172a 0%, #4F46E5 50%, #22D3EE 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text', display: 'block', marginBottom: '24px' }}>
            Your pipeline won't fill itself.
          </div>

          {/* Subtext */}
          <p style={{ fontSize: '20px', color: '#475569', lineHeight: 1.6, marginBottom: '48px', maxWidth: '600px', margin: '0 auto 48px' }}>
          ...
          <div style={{ display: 'flex', gap: '16px', justifyContent: 'center', alignItems: 'center', flexWrap: 'wrap', marginBottom: '24px' }}>
            <button style={{ background: '#1E1B4B', color: 'white', borderRadius: '12px', padding: '16px 36px', fontWeight: 700, fontSize: '16px', border: 'none', cursor: 'pointer', fontFamily: 'Switzer, sans-serif', boxShadow: '0 8px 32px rgba(30,27,75,0.25)', transition: 'transform 0.2s ease, box-shadow 0.2s ease' }}
            ...
            <button style={{ background: 'transparent', color: '#4F46E5', border: '1px solid rgba(79,70,229,0.3)', borderRadius: '12px', padding: '16px 36px', fontWeight: 600, fontSize: '16px', cursor: 'pointer', fontFamily: 'Switzer, sans-serif', transition: 'all 0.2s ease' }}
