            ...
            <div style={{display:'grid', gridTemplateColumns:'220px 1fr', minHeight:'540px'}}>
              ...
              <div style={{background:'#f8f9fa', padding:'20px', display:'flex', flexDirection:'column', gap:'14px', overflow:'hidden'}}>
                ...
                <div style={{display:'flex', justifyContent:'space-between', alignItems:'flex-start', marginBottom:'16px'}}>
                  <div>
                    <div style={{fontSize:'18px', fontWeight:700, color:'#0f172a', fontFamily:'Switzer, sans-serif'}}>Dashboard</div>
                    <div style={{fontSize:'11px', color:'#64748b', fontFamily:'Switzer, sans-serif'}}>Overview of your outreach performance</div>
                  </div>
                  <div style={{display:'flex', gap:'8px', alignItems:'center'}}>
                    ...
                    <div style={{
                      ...
                      <div>
                        <div style={{fontSize:'11px', fontWeight:600, color:'#0f172a', fontFamily:'Switzer, sans-serif', lineHeight:1}}>Iain L.</div>
                        <div style={{fontSize:'9px', color:'#94a3b8', fontFamily:'Switzer, sans-serif'}}>Admin</div>
                      </div>
                      <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="#94a3b8" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                        <polyline points="6 9 12 15 18 9"/>
                      </svg>
                    ...
                    <div style={{
                      ...
                      <span style={{fontSize:'16px', lineHeight:1}}>+</span> New Campaign
                    </div>
                  </div>
                </div>
                    ...
                    <div style={{
                      ...
                      {[
                        ...
                        <div key={s.label} style={{textAlign:'center' as const}}>
                          <div style={{fontSize:'18px', fontWeight:800, color:'#0f172a', fontFamily:'Switzer, sans-serif'}}>{s.value}</div>
                          <div style={{display:'flex', alignItems:'center', justifyContent:'center', gap:'3px', marginTop:'2px'}}>
                            <div style={{fontSize:'9px', fontWeight:600, color:'#94a3b8', letterSpacing:'0.06em', fontFamily:'Switzer, sans-serif'}}>{s.label}</div>
                            <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="#94a3b8" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
