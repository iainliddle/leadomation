    ...
    return (
        <div className="p-6 bg-[#F8F9FA] min-h-screen">
            <div className="max-w-5xl mx-auto">
                ...
                {/* Free Trial Banner */}
                <div className="bg-gradient-to-r from-[#4F46E5] to-[#6366F1] rounded-xl p-5 mb-8 flex items-center gap-4 text-white">
                    <Zap size={24} className="text-white" />
                    <div>
                        <span className="font-bold">Start with a 7-day free trial</span>
                        <span className="text-indigo-200 ml-2">Full Pro access, no restrictions on features.</span>
                    </div>
                </div>
                ...
                {/* Bottom CTA */}
                <div className="bg-gradient-to-r from-[#4F46E5] to-[#6366F1] rounded-2xl p-8 text-center">
                    <h2 className="text-2xl font-bold text-white mb-3">Still not sure?</h2>
                    ...
                    <button
                        ...
                        disabled={isLoading}
                        className="px-8 py-3 bg-white text-[#4F46E5] font-semibold rounded-xl hover:bg-indigo-50 transition-all shadow-lg flex items-center gap-2 mx-auto"
                    >
