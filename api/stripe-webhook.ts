...
<table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:24px;">
  <tr><td style="padding:8px 0;"><a href="https://www.leadomation.co.uk/cancellation-feedback.html?reason=too_expensive&userId={{user_id}}" style="display:block;padding:12px 20px;background:#F8F9FF;border:1px solid #E5E7EB;border-radius:8px;font-size:14px;color:#374151;text-decoration:none;">💰 It was too expensive</a></td></tr>
  <tr><td style="padding:8px 0;"><a href="https://www.leadomation.co.uk/cancellation-feedback.html?reason=missing_features&userId={{user_id}}" style="display:block;padding:12px 20px;background:#F8F9FF;border:1px solid #E5E7EB;border-radius:8px;font-size:14px;color:#374151;text-decoration:none;">🔧 It was missing features I needed</a></td></tr>
  <tr><td style="padding:8px 0;"><a href="https://www.leadomation.co.uk/cancellation-feedback.html?reason=too_complicated&userId={{user_id}}" style="display:block;padding:12px 20px;background:#F8F9FF;border:1px solid #E5E7EB;border-radius:8px;font-size:14px;color:#374151;text-decoration:none;">😕 It was too complicated to use</a></td></tr>
  <tr><td style="padding:8px 0;"><a href="https://www.leadomation.co.uk/cancellation-feedback.html?reason=no_longer_needed&userId={{user_id}}" style="display:block;padding:12px 20px;background:#F8F9FF;border:1px solid #E5E7EB;border-radius:8px;font-size:14px;color:#374151;text-decoration:none;">📦 I no longer need it</a></td></tr>
</table>
<p style="margin:0 0 20px;font-size:15px;color:#374151;line-height:1.7;">
